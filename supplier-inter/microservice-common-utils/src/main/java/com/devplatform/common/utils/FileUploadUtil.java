...
public class FileUploadUtil {
     ...
     */
    public static String upload(HttpServletRequest request, MultipartFile file, String filePath, String exsitPath) {
        String Path = "";
        ...
        if (file != null && !file.isEmpty()) {
            ...
            // 系统路径
            String realBaseDir = request.getSession().getServletContext().getRealPath("/" + dataPath.toString());
            ...
            String fileRealName = DateUtil.format(new java.util.Date(), "yyyyMMddHHmmss") + num + "dr" + "." + ext;
            // 上传文件
            try {
                ...
                if (exsitPath != null && !"upload/user/defaultface.jpg".equals(exsitPath)) {
                    String oldrealBaseDir = request.getSession().getServletContext().getRealPath("/upload");
