  ...
  <div class="warpper">
    <div class="main">
      ...
      <div class="modularDiv div_bg">
        ...
        <input type="text" id="code" v-model="verifyCode" placeholder="请输入短信验证码">
      ...
      <div class="modularDiv div_bg">
        ...
        <input type="password" id="password" v-model="pwd" placeholder="请输入密码">
      </div>
      <div class="modularDiv landBtn" v-on:click="saveForApp">
        我要回家
      </div>
    </div>
  </div>
...
export default {
  ...
  methods: {
    saveForApp () {
      ...
      let _this = this;
      this.$api.post('/sysUser/saveForApp.do', data, function (data) {
