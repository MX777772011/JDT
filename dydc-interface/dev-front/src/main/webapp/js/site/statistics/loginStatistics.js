...
function search() {
	loadPage('loginList.shtml?minOperationTime='+$('#minOperationTime').val()
...
function searchYesterday() {
	...
	loadPage('loginList.shtml?minOperationTime='+yesterday
...
function searchLastWeek() {	
	...
	loadPage('loginList.shtml?minOperationTime='+lastWeekMonday
