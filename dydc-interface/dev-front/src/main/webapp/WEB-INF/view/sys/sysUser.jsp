...
<link rel="stylesheet"
	href="${msUrl}/css/bcss/bootstrap-multiselect.css">
<script type="text/javascript" src="${msUrl}/js/sys/sysUser.js"></script>
<script src="${msUrl}/js/bootstraplib/bootstrap-multiselect.js"></script>
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/css/zTreeStyle/zTreeStyle.css"
	type="text/css">
<script type="text/javascript"
	src="<%=request.getContextPath()%>/js/jquerylib/ztree/jquery.ztree.core-3.5.js"></script>
<script type="text/javascript"
	src="<%=request.getContextPath()%>/js/jquerylib/ztree/jquery.ztree.excheck-3.5.js"></script>
<script type="text/javascript"
	src="<%=request.getContextPath()%>/js/jquerylib/ztree/jquery.ztree.exedit-3.5.js" /></script>
