...
<div class="panel" style=" background:#e4e7ea;">
   <div class="panel-heading" style=" margin-bottom:20px;">
		...
		<div class="form-group" style="width:100%!important">
			...
			#end
		   		<p>
					<button type="button"  onclick="STableUtils.reloadTable()" class="_btn btn-chaxun">查询</button>
					<span class="_btn btn-add" onclick="add()" fun="add">添加</span>
					<span class="_btn btn-del" onclick="del()" fun="remove">删除</span> 
				</p>  
		</div>
		</form>
