...
<%@include file="/WEB-INF/view/include.jsp" %>
  ...
  <div class="panel">
    ...
    <form action="${msUrl}/redisDemo/insertRedis.do" method="post" class="form-inline" style="margin-top: 30px;">
    ...
    <form action="${msUrl}/redisDemo/getRedisInfo.do" method="post"  class="form-inline" style="margin-top: 30px;margin-bottom: 30px;">
 		<span class="manage_unit clearfix">
