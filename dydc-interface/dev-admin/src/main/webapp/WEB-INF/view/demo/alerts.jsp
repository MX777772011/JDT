        ...
        <div class="col-md-6">
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              ...
              <p>You can view more examples in using modals in <a href="javascript:void(0)">here</a></p>
            </div>
          </div><!-- panel -->
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              <a href="javascript:void(0)" class="btn btn-default mr5" id="growl1">Growl With Image</a>
              <a href="javascript:void(0)" class="btn btn-default" id="growl2">Growl Without Image</a>
              
              <div class="mb10"></div>
              
              <a href="javascript:void(0)" class="btn btn-primary mr5 mb10" id="growl-primary">Primary</a>
              <a href="javascript:void(0)" class="btn btn-success mr5 mb10" id="growl-success">Success</a>
              <a href="javascript:void(0)" class="btn btn-warning mr5 mb10" id="growl-warning">Warning</a>
              <a href="javascript:void(0)" class="btn btn-danger mr5 mb10" id="growl-danger">Danger</a>
              <a href="javascript:void(0)" class="btn btn-info mb10" id="growl-info">Info</a>
