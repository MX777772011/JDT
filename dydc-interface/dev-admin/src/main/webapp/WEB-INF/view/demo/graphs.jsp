...
<script src="${msUrl}/js/jquerylib/flot/jquery.flot.symbol.min.js"></script>
<script src="${msUrl}/js/jquerylib/flot/jquery.flot.crosshair.min.js"></script>
<script src="${msUrl}/js/jquerylib/flot/jquery.flot.categories.min.js"></script>
<script src="${msUrl}/js/jquerylib/flot/jquery.flot.pie.min.js"></script>
<script src="${msUrl}/js/bootstraplib/morris.min.js"></script>
<script src="${msUrl}/js/bootstraplib/raphael-2.1.0.min.js"></script>

<script src="${msUrl}/js/bootstraplib/charts.js"></script>
