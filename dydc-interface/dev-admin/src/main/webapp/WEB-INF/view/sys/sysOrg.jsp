...
<script type="text/javascript">
	...
	var setting = {
			async: {
				enable: true,
				dataType: "json",
				url:"<c:url value="findList.do"/>"//加载树
			},
			edit: {
		...
		function addTreeNode() {
			...
			var id = nodes[0].id;
			$("#ifr1").attr("src","getOrgById.shtml?id="+id+"&type=add");
		}
		...
		function zTreeOnClick(event, treeId, treeNode) {
    		//alert(treeNode.tId + ", " + treeNode.name);
   			var id=treeNode.id;
			$("#ifr1").attr("src","getOrgById.shtml?id="+id);
		}
...
<div class="panel">
	...
	<div class="col-sm-7"   id="ifdiv" >
		<iframe src="getOrgById.shtml" id="ifr1" width="730px;" height="550px;" frameborder="no" border="0" scrolling="no"></iframe>
	</div>	
	</div>						
</div>
