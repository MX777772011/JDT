...
<%@include file="/WEB-INF/view/include.jsp"%>
	 <script type="text/javascript" src="<%=path %>/js/sys/sysUserRole.js"></script> 
	 <script src="${msUrl}/js/bootstraplib/bootstraptable/bootstrap-multiselect.js"></script>
...
<form action="" class="list_con_form clearfix" id="searchForm">
  ...
  <span class="manage_unit clearfix">
    <input type="button" value="查询" onclick="STableUtils.reloadTable()" class="h32 inline_blo flole prl20 orage_bg" >
  </span>
</form>
