...
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/css/bcss/bootstraptable/layer.css">
...
<script type="text/javascript" src="<%=request.getContextPath()%>/js/jquerylib/jquery-1.11.1.min.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/js/jquerylib/jquery.formFill.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/js/jquerylib/validate/jquery.validate.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/js/jquerylib/validate/jquery.validate.min.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/js/jquerylib/validate/valadate-message.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/js/layer/layer.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/js/jquerylib/ztree/jquery.ztree.core-3.5.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/js/jquerylib/ztree/jquery.ztree.excheck-3.5.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/js/jquerylib/ztree/jquery.ztree.exedit-3.5.js"/></script>
   <script src="<%=request.getContextPath()%>/js/bootstraplib/bootstrap.min.js"></script>
