...
<script type="text/javascript" src="${msUrl}/js/wechat/weixinPrizerecord/weixinPrizerecord.js"></script>
...
<form action="" class="list_con_form clearfix" id="searchForm">
	...
	<!--火狐浏览器30以上的版本下拉框宽高合适，30以下不合适  -->
		...
		<span class="manage_unit clearfix"> <input type="button" value="查询"
			onclick="STableUtils.reloadTable()" class="h32 inline_blo flole prl20 orage_bg"> </span>
</form>
