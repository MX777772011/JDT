...
<html>
 <head>
  <title>微信单图消息</title>
  <link type="text/css" rel="stylesheet" href="css/wechat/appmsg_edit.css" />
  <link type="text/css" rel="stylesheet" href="css/wechat/jquery.fileupload.css" />
  <link rel="stylesheet" href="css/bcss/bootstrap.min.css">
  
  	<link rel="stylesheet" type="text/css" href="css/hebase.css">
  	<link rel="stylesheet" type="text/css" href="css/liststyle.css">
  <link type="text/css" rel="stylesheet" href="css/wechat/easyui.css" />
  <link type="text/css" rel="stylesheet" href="css/wechat/icon.css" />
   <link type="text/css" rel="stylesheet" href="css/wechat/common.css" />
   <link type="text/css" rel="stylesheet" href="css/wechat/accordion.css" />
   <link href="css/wechat/button.css" type="text/css" rel="stylesheet"/>
   
  <script type="text/javascript" src="js/wechat/weixin/ckfinder.js"></script>
  <script src="js/jquerylib/jquery-1.11.1.min.js"></script>
  <!--jquery-form-->
  <script src="js/jquery-form.js"></script>
   	<script type="text/javascript" src="js/jquerylib/jquery-ui-1.10.3.min.js"></script>
   	<script type="text/javascript" src="js/jquerylib/jquery.formFill.js"></script>
   	 <!--validate-->
    <script type="text/javascript" src="js/jquerylib/validate/jquery.validate.js"></script>
   	<script type="text/javascript" src="js/jquerylib/validate/valadate-message.js"></script> 
   	 <!--layer-->
   	 <link rel="stylesheet" type="text/css" href="css/layer/layer.css">
	<link rel="stylesheet" type="text/css" href="css/layer/laycode.css">
   	<script src="js/layer/layer.js"></script>
	<script src="js/layer/laycode.js"></script>
   	  <!--fileupload-->
  <script type="text/javascript" src="js//wechat/weixin/jquery.ui.widget.js"></script>
  <script type="text/javascript" src="js//wechat/weixin/load-image.min.js"></script>
  <script type="text/javascript" src="js//wechat/weixin/jquery.fileupload.js"></script>
  <script type="text/javascript" src="js//wechat/weixin/jquery.fileupload-process.js"></script>
  <script type="text/javascript" src="js//wechat/weixin/jquery.fileupload-image.js"></script>
  <script type="text/javascript" src="js//wechat/weixin/jquery.iframe-transport.js"></script>
  <!--UEditor-->
...
$(function () {
 ...
 <body>
  ...
  <script src = "<%=request.getContextPath() %>js//wechat/weixinNewstemplate/weixinArticle.js"></script>				