...
<link href="<%=path %>/css/wechat/ggl/ggl.css" rel="stylesheet" type="text/css"/>
<link href="<%=path %>/css/wechat/zp/activity-style.css" rel="stylesheet" type="text/css">
<!-- <script src="http://libs.baidu.com/jquery/2.0.0/jquery.min.js" type="text/javascript"></script> -->
<script type="text/javascript" src="<%=path %>/js/wechat/weixinHuodong/wScratchPad.js"></script>
