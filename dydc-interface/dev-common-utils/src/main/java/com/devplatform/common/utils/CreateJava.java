...
//import com.devplatform.sys.bean.SiteMain;
//import com.devplatform.sys.bean.SysMenu;
//import com.devplatform.sys.bean.SysMenuBtn;
//import com.devplatform.sys.service.SiteMainService;
...
public class CreateJava {
	private static ResourceBundle res = ResourceBundle
			.getBundle("config/default/createJava");
	...
	public static void main(String[] args) {
		...
		//执行后直接生成对应增删改查
		/** 此处修改成你的 表名 和 中文注释 ***/
		String tableName = "testcreate"; //表名称  ----------这里需要改
		String codeName = "测试生成器表";// 中文注释 当然你用英文也是可以的 ----------这里需要改
		String tableSchema="baseframe";//一般为指定库，为空字符串也可以，如果需要生成其他库的表，则写其他库的schema
