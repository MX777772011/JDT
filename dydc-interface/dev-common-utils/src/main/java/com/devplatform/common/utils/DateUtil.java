...
public class DateUtil {
	...
	public static java.text.SimpleDateFormat sdfLong2 = new java.text.SimpleDateFormat("yyyy/MM/dd");
	...
	public static String formatDateTime(String _dateTime, String _format) throws Exception {
		...
		try {
			...
			if (!strDay.equals("")) {
				...
				if ((strMonth.equals("02")) || (strMonth.equals("04")) || (strMonth.equals("06")) || (strMonth.equals("09")) || (strMonth.equals("11"))) {
					if (intDay > 30) {
						strDay = "30";
						intDay = 30;
					}
	 ...
	 * @return
	 */
	protected static List<Date> getWorkDates(int year, int month) {
	...
	private static SimpleDateFormat[] loadDateFormats() {
		SimpleDateFormat[] temp = {
				...
				new SimpleDateFormat("M/d/yy hh:mm:ss"), new SimpleDateFormat("M/d/yyyy hh:mm:ss"), new SimpleDateFormat("M/d/yy hh:mm a"), new SimpleDateFormat("M/d/yyyy hh:mm a"), new SimpleDateFormat("M/d/yy HH:mm"), new SimpleDateFormat("M/d/yyyy HH:mm"),
				new SimpleDateFormat("dd.MM.yyyy HH:mm:ss"), new SimpleDateFormat("yy-MM-dd HH:mm:ss.SSS"), new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.SSS"),
				// standard Timestamp.toString() results
				new SimpleDateFormat("M-d-yy HH:mm"), new SimpleDateFormat("M-d-yyyy HH:mm"), new SimpleDateFormat("MM/dd/yyyy HH:mm:ss.SSS"), new SimpleDateFormat("M/d/yy"), new SimpleDateFormat("M/d/yyyy"), new SimpleDateFormat("M-d-yy"), new SimpleDateFormat("M-d-yyyy"),
	...
	public static String getMonthString(Date date1, int addMonth) {
		...
		java.text.SimpleDateFormat sdfShort = new java.text.SimpleDateFormat("yyyyMM");
	...
	public static String getOnlyMonthString(Date date1, int addMonth) {
		...
		cal.setTime(date1);
		cal.add(Calendar.MONTH, addMonth);
		java.text.SimpleDateFormat sdfShort = new java.text.SimpleDateFormat("M");
		return sdfShort.format(cal.getTime());
	}
	...
	public static boolean isAcrossMonth(Date start, Date end) {
		...
		ce.setTime(end);
		return cs.get(Calendar.MONTH) != ce.get(Calendar.MONTH);
	}
	...
	public static void main(String[] args) {
		try {
			...
			//
			// System.out.println(isSameDate(new Date(),new
			// Date("2015/12/16")));
			// System.out.println(DateUtil.toDayToStr("yyyy年MM月dd日"));
			// System.out.println("###"+daysBetweenExcludeWeekendsDates(new
			// Date("2015/12/31"),new Date("2015/12/01")));
			// // System.out.println("我的年龄：" +
			// DateUtil.getAge("210202720508171"));
			// // System.out.println("我的年龄：" +
